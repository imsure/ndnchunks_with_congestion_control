...
main(int argc, char** argv)
{
  ...
  visibleDesc.add_options()
    ...
    ("output-stats,s", po::bool_switch(&options.keepStats), "keep track of stats and output stats to files")
  ...
  try {
    ...
    RttEstimator::Options optionsRttEstimator(options);
    RttEstimator rttestimator(optionsRttEstimator);

    PipelineInterests::Options optionsPipeline(options);
    optionsPipeline.maxPipelineSize = maxPipelineSize;
    PipelineInterests pipeline(face, rttestimator, optionsPipeline);
